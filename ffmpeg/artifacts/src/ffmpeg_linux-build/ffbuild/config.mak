...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--extra-cflags=-I/home/td/code/dicroce/revere/ffmpeg/../x264/artifacts/include --extra-ldflags=-L/home/td/code/dicroce/revere/ffmpeg/../x264/artifacts/lib --prefix=/home/td/code/dicroce/revere/ffmpeg/artifacts --enable-gpl --enable-libx264 --enable-shared --disable-static --enable-pthreads --disable-optimizations --disable-mmx --disable-stripping --enable-vaapi --enable-hwaccel=h264_vaapi --enable-libmp3lame --disable-programs --disable-doc
...
INSTALL_NAME_DIR=
SRC_PATH=/home/td/code/dicroce/revere/ffmpeg/build/ffmpeg_sources
SRC_LINK=src
...
CFLAGS=  -I/home/td/code/dicroce/revere/ffmpeg/../x264/artifacts/include -std=c11 -fPIC -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation  -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -I/home/td/code/dicroce/revere/ffmpeg/../x264/artifacts/include -fPIC -g
...
DEPWINDRES=gcc
DOXYGEN=doxygen
LDFLAGS= -L/home/td/code/dicroce/revere/ffmpeg/../x264/artifacts/lib  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
...
EXTRALIBS=-lva -lva-drm -lva -lx264 -lmp3lame -lm -ldl -lbz2 -lz -pthread -pthread 
COMPAT_OBJS=
INSTALL=install
LIBTARGET=
