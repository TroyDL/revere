...
private:
    ...
    std::string _get_scope_field(const std::string& scope, const std::string& field_name) const;
    std::string _get_camera_name(int index) const;
    std::string _extract_xaddrs(int index) const;
    std::string _extract_address(int index) const;
    std::string _get_xml_value(xmlDocPtr doc, const std::string& xpath) const;
    ...
    xmlDocPtr _send_command_to_camera(const std::string& cmd, const std::string& xaddrs) const;
