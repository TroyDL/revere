...
REGISTER_TEST_FIXTURE(test_r_utils_r_blob_tree);

void test_r_utils_r_blob_tree::setup()
{
}

void test_r_utils_r_blob_tree::teardown()
{
}
...
void test_r_utils_r_blob_tree::test_basic()
{
...
void test_r_utils_r_blob_tree::test_objects_in_array()
{
    r_blob_tree rt1;
