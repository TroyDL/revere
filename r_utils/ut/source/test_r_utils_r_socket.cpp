...
REGISTER_TEST_FIXTURE(test_r_utils_r_socket);

void test_r_utils_r_socket::setup()
{
}

void test_r_utils_r_socket::teardown()
{
}

void test_r_utils_r_socket::test_client_server()
{
    try
    {
...
void test_r_utils_r_socket::test_move_constructable()
{
    try
    {
        r_socket sokA;
...
void test_r_utils_r_socket::test_move_assignable()
{
    r_socket sokA;
    sokA.connect( "www.google.com", 80 );
    string query = "GET /\r\n\r\n";
...
void test_r_utils_r_socket::test_close_warm_socket()
{
    int port = RTF_NEXT_PORT();
...
void test_r_utils_r_socket::test_wont_block()
{
    int port = RTF_NEXT_PORT();
...
void test_r_utils_r_socket::test_buffered_socket()
{
