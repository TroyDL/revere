                           ...
                           const r_server_request& request)
{
    ...
    r_video_encoder e(r_av_codec_id_mjpeg, r_av_pix_fmt_yuv420p, r_string_utils::s_to_uint16(args["width"]), r_string_utils::s_to_uint16(args["height"]), 15, 500000, 1, 15, get_encoder_options("baseline", "fast", "", 2));
    e.encode_image(pic);
    auto epkt = e.get();
